...
distance_x = np.loadtxt(open("E:/86191/Documents/qq/MobileFile/simple1.csv","rb"),delimiter=",")
distance_y = np.loadtxt(open("E:/86191/Documents/qq/MobileFile/simple2.csv","rb"),delimiter=",")
#城市距离和信息素
