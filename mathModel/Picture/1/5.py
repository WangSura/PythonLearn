...
# Step 1: Prepare Data
midwest = pd.read_csv(
    "D:/program/pythonPractice/mathModel/Picture/1/datasets-master/midwest_filter.csv")
...
for i, category in enumerate(categories):
    plt.scatter('area', 'poptotal', data=midwest.loc[midwest.category == category, :], s='dot_size', c=colors[i], label=str(
