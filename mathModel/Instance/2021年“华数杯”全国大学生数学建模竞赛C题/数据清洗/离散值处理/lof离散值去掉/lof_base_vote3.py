...
posi = pd.read_excel(
    r'D:\program\pythonPractice\数模\2021年“华数杯”全国大学生数学建模竞赛C题\数据清洗\离散值处理\处理方便机器学习3.xlsx')
...
outliers4, inliers4 = ensemble_lof(
    A, B, k=16, method=[0, 1], vote_method=1)
outliers4.to_excel(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/out3.xlsx")
inliers4.to_excel(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/in3.xlsx")
...
plt.savefig(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/品牌三离散图.png")
