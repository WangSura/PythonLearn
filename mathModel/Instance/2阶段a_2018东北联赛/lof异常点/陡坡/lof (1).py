...
outliers4, inliers4 = ensemble_lof(
    A, predict=None, k=40, groups=[[0, 1]], method=0.7, vote_method='auto')
outliers4.to_excel(
...
plt.scatter(outliers4[0], outliers4[1], s=1000 +
            outliers4['local outlier factor [0, 1]']*2000, c=outliers4[1]*10, alpha=0.3, cmap='rainbow')
plt.title('k = 40, method = 0.7')
# title自己要改
plt.show()
