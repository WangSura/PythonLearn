...
outliers4, inliers4 = ensemble_lof(
    A, predict=None, k=29, groups=[[0, 1]], method=0.17, vote_method='auto')
outliers4.to_excel(
    "D:/program/pythonPractice/mathModel/Instance/2阶段a_2018东北联赛/二阶段/p3_version1/out4.xlsx")
inliers4.to_excel(
    "D:/program/pythonPractice/mathModel/Instance/2阶段a_2018东北联赛/二阶段/p3_version1/in4.xlsx")
...
plt.scatter(outliers4[0], outliers4[1], s=100 +
            outliers4['local outlier factor [0, 1]']*3000, c=outliers4[1]*10, alpha=0.3, cmap='rainbow')
plt.title('k = 25, method = 0.8')
# title自己要改
plt.show()
