...
outliers4.to_excel(
    "D:/program/pythonPractice/mathModel/Instance/2阶段a_2018东北联赛/二阶段/p3_version1/out3.xlsx")
inliers4.to_excel(
    "D:/program/pythonPractice/mathModel/Instance/2阶段a_2018东北联赛/二阶段/p3_version1/in3.xlsx")
...
plt.scatter(outliers4[0], outliers4[1], s=1000 +
            outliers4['local outlier factor [0, 1]']*500, c=outliers4[1]*10, alpha=0.3, cmap='rainbow')
plt.title('k = 22, method = 0.1')
# title自己要改
plt.show()
