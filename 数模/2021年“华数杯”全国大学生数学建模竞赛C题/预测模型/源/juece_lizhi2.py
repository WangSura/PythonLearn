...
import pandas as pd
df = pd.read_excel(
    'D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/预测模型/处理方便机器学习2.xlsx')
...
model = DecisionTreeClassifier(
    criterion='gini', max_depth=3, min_samples_split=2, splitter='best')  # 97不要random_state
model.fit(X_train, y_train)
...
# 保存模型
joblib.dump(model, dirs+'/model2.pkl')
