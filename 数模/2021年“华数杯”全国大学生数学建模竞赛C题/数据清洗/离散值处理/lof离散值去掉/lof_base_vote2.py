...
posi = pd.read_excel(
    r'D:\program\pythonPractice\数模\2021年“华数杯”全国大学生数学建模竞赛C题\数据清洗\离散值处理\处理方便机器学习2.xlsx')
...
# 获取会员对任务密度，取第5邻域，阈值为 100，权重分别为25，1
outliers4, inliers4 = ensemble_lof(A, B, k=78, method=[0.5, 1], vote_method=1)
outliers4.to_excel(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/out2.xlsx")
inliers4.to_excel(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/in2.xlsx")
...
plt.title('k = 78, method = [0.5, 1]')
plt.show()
plt.savefig(
    "D:/program/pythonPractice/数模/2021年“华数杯”全国大学生数学建模竞赛C题/数据清洗/离散值处理/品牌二离散图.png")
